...
class ChatBubble extends StatelessWidget {
  ...
  ChatBubble(
      {required Key key, required this.msg, required this.time, required this.msgType, required this.isMe, required this.isSeen})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    //messsage bubble
    _buildMessageBubble({required String message, required bool isMe}) {
      return Container(
    ...
    //image bubble
    _buildImageBubble({required String message, required bool isMe}) {
      return Column(
    ...
    //voice note bubble
    _buildVoiceBubble({required String message, required bool isMe}) {
      return Container(
