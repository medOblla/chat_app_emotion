...
class NotifWidget extends StatefulWidget {
  ...
  const NotifWidget(
      {required Key key, required this.userName, required this.time, required this.notType, required this.userImg})
      : super(key: key);
  @override
...
class _NotifWidgetState extends State<NotifWidget> {
  ...
  _buildReqNotif({required String username, required String imgUrl, required String time}) {
    return InkWell(
      onTap: () {
        setState(() {
          isAccepted = "...";
  ...
  _buildContainer({required Color color1, required Color color2, required String btnTxt}) => Padding(
  ...
  _buildPayNotif({required String username, required String imgUrl, required String time}) {
    return Container(
        child: Center(
      child: ListTile(
        leading: Container(
